...
-   **KStars Log Management Details**: The script now searches for logs within the new `/home/stellarmate/.indi/logs/` directory, specifically looking for files in the `indi_pifinder_lx200` subdirectory. It dynamically finds the *newest log file* and appends it to the build log for easy access and review.
