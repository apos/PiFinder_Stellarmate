...
- **`bin/build_indi_driver.sh`**: Heavily refactored for speed, safety, and debuggability.
    ...
    - **Why (KStars Log Management):** This functionality was restored to clear old KStars logs, wait for a testing period, and then copy the latest log for easy inspection, which is vital for debugging driver behavior.
